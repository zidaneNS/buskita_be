...
POST | api/seats | { seat_id } | { seat_number, user_id, user_name, schedule_id } | 200 | user attach seat | 1
GET | api/seats/schedule/:id | - | [{ seat_number, id, user_name, user_id, verified, schedule_id }] | 200 | get all seat list | 1
GET | api/seats/:id | - | {seat_number, id, user_name, user_id, verified, schedule_id } | 200 | get seat by id | 1
...
PUT | api/seats/:id | { new_seat_id } | { seat_number, id, user_name, user_id, verified, schedule_id } | 200 | user move their seat | 1
GET | api/seats/:id/verify | - | { seat_number, id, user_name, user_id, verified, schedule_id } | 200 | co/co_leader verify user | 1
